function blogGet() {
    ...
    xhttp.onload = function() {
        ...
        for (let x = 0; x < objResponse.list.length; x++) {
            ...
            + '</p></div>'
            + '<div class="info"><div class="lajkovi"><svg  onclick="myfunction(\'prst' + x + '\')" id="prst' + x + '" class="prst" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-thumb-up" width="30" height="30" viewBox="0 0 24 24" stroke-width="0.5" stroke="#2c3e50" style="fill: black;" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 11v8a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1v-7a1 1 0 0 1 1 -1h3a4 4 0 0 0 4 -4v-1a2 2 0 0 1 4 0v5h3a2 2 0 0 1 2 2l-1 5a2 3 0 0 1 -2 2h-7a3 3 0 0 1 -3 -3" /></svg> <span></span> </div>'
